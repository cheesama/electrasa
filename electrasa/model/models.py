...
class KoELECTRAFineTuner(nn.Module):
    def __init__(self, intent_class_num, entity_class_num, default_model_path='monologg/koelectra-small-v2-discriminator'):
        ...
        self.entity_featurizer = nn.Linear(self.entity_class_num, self.entity_class_num)
    ...
    def forward(self, tokens):
        ...
        entity_pred = self.entity_embedding(feature[:,1:,:]) #excep first [CLS] token
        entity_pred = self.entity_featurizer(entity_pred) 
